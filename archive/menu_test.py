...
menu_data = {
  ...
  'options':[
    { 'title': "Create arff from dataset", 'type': COMMAND, 'command': 'xbmc' },
        { 'title': "Test perceptron on dataset", 'type': COMMAND, 'command': 'emulationstation' },
        { 'title': "Run perceptron interactively", 'type': COMMAND, 'command': 'uqm' },
        { 'title': "Download posts from subreddit...", 'type': MENU, 'subtitle': "Please select subreddit...",
        'options': [
          { 'title': "/r/suicidewatch", 'type': COMMAND, 'command': 'dosbox /media/samba/Apps/dosbox/doswin/games/SSR/SSR.EXE -exit' },
          { 'title': "/r/rant", 'type': COMMAND, 'command': 'dosbox /media/samba/Apps/dosbox/doswin/games/SSO/SSO.EXE -exit' },
          { 'title': "/r/personalfinance", 'type': COMMAND, 'command': 'dosbox /media/samba/Apps/dosbox/doswin/games/SST/SST.EXE -exit' },
        ]
        },
